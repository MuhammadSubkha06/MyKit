        ...
        <div class="row justify-content-center">
            <div class="col-md-5 col-lg-4">
                ...
                <div class="text-center mb-4">
                    ...
                    <p style="font-size:0.875rem;color:var(--muted);margin-top:0.5rem">Mulai perjalanan kesehatanmu hari
                        ini — gratis!</p>
                </div>
                ...
                <div class="card auth-card">
                    <div class="card-body p-4">
                        ...
                        <h4 style="font-size:1.1rem;font-weight:700;color:var(--txt);margin-bottom:0.25rem">Buat akun
                            baru 🌸</h4>
                        <p style="font-size:0.82rem;color:var(--muted);margin-bottom:1.5rem">Tidak perlu kartu kredit.
                            Mulai dalam 1 menit.</p>
                        ...
                        <form method="post" action="/register">
                            ...
                            <!-- Benefits mini list -->
                            <div
                                style="background:var(--pk5);border-radius:var(--radius-sm);padding:0.75rem 1rem;margin-bottom:1rem;border:0.5px solid var(--pk3)">
                                <div style="font-size:0.75rem;color:var(--txt2)">
                                    <div class="mb-1"><i class="bi bi-check-circle-fill me-2"
                                            style="color:var(--pk)"></i>Gratis selamanya</div>
                                    <div class="mb-1"><i class="bi bi-check-circle-fill me-2"
                                            style="color:var(--pk)"></i>Prediksi siklus akurat</div>
                                    <div><i class="bi bi-check-circle-fill me-2" style="color:var(--pk)"></i>Data privat
                                        & aman</div>
                                </div>
                            </div>
                ...
                <p class="text-center mt-4" style="font-size:0.72rem;color:var(--muted)">
                    Dengan mendaftar, kamu menyetujui <a href="#" style="color:var(--pk)">Syarat & Ketentuan</a> dan <a
                        href="#" style="color:var(--pk)">Kebijakan Privasi</a> kami.
                </p>
            </div>
        </div>
    </div>
